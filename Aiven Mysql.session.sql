...
-- --   ADD COLUMN artist_country VARCHAR(100);
...
-- -- ALTER TABLE tracks
-- --   ADD COLUMN top_track VARCHAR(100);
...
--   -- promo TEXT,
--   -- FOREIGN KEY (track_id) REFERENCES tracks(id) ON DELETE CASCADE-- Soul Felt Music PostgreSQL Schema
-- -- Run these commands in psql or a migration tool
...
-- --   ADD COLUMN Featured_Tracks TEXT
