...
function UploadNewArtist() {
  ...
  const { requiredFields, booleanFields, handleLocalSubmit } = useArtistFormValidation(fields, fieldValues, handleUploadNewRecord);
  ...
  return (
    <form onSubmit={e => handleLocalSubmit(e, "upload")}
